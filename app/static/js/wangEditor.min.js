!function (e, t) {
    ...
    function d(e, t) {
        ...
        var a = t.list || [], s = t.type || "list", l = t.onClick || $, d = o('<ul class="' + ("list" === s ? "w-e-list" : "w-e-block") + '"></ul>');
    ...
    f.prototype = {
        ...
        constructor: m, onClick: function (e) {
            ...
            var n = this, i = c("input-link"), A = c("input-text"), r = c("btn-ok"), a = c("btn-del"), s = this._active ? "inline-block" : "none", l = new f(this, {
                width: 300,
                tabs: [{
                    title: "链接",
    ...
    q.bold = l, q.head = u, q.fontSize = h, q.fontName = p, q.link = m, q.italic = g, q.redo = w, q.strikeThrough = v, q.underline = E, q.undo = b, q.list = B, q.justify = y, q.foreColor = C, q.backColor = x, q.quote = I, q.code = Q, q.emoticon = M, q.table = S, q.video = k, q.image = D, _.prototype = {
        ...
        constructor: U, init: function () {
            ...
            var n = this.editor, i = n.config, o = i.pasteFilterStyle, A = i.pasteTextHandle, r = i.pasteIgnoreImg, c = n.$textElem, a = 0;
    ...
    L.prototype = {
        constructor: L, _alert: function (e, t) {
            ...
            var t = this;
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgServer, c = i.uploadImgShowBase64, a = i.uploadImgMaxSize, s = a / 1024 / 1024, l = i.uploadImgMaxLength || 1e4, d = i.uploadFileName || "", u = i.uploadImgParams || {}, h = i.uploadImgParamsWithUrl, p = i.uploadImgHeaders || {}, f = i.uploadImgHooks || {}, m = i.uploadImgTimeout || 3e3, g = i.withCredentials;
                null == g && (g = !1);
